...
import com.android.internal.util.centauri.DeviceUtils.FilteredDeviceFeaturesArray;
import com.android.settings.centauri.CentauriActionShortcut;

import com.android.settings.R;

public class CreateCentauriShortcut extends Activity {
    ...
    public void onResume() {
        ...
        .setNegativeButton(R.string.cancel,
            ...
            public void onClick(DialogInterface dialog, int which) {
                CreateCentauriShortcut.this.finish();
            }
        })
        .setItems(dialogEntries,
            ...
            public void onClick(DialogInterface dialog, int item) {
                Intent shortcutIntent = new Intent(
                        CreateCentauriShortcut.this, CentauriActionShortcut.class);
                shortcutIntent.putExtra("value", dialogValues[item]);

                Drawable icon = ButtonsHelper.getButtonIconImage(
                        CreateCentauriShortcut.this, dialogValues[item], null);
