...
public class NavigationSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.centauri_navigation_settings);
    ...
    private void updateSettings() {
        ...
        boolean enableNavigationBar = Settings.System.getInt(getContentResolver(),
                ...
                CentauriActions.isNavBarDefault(getActivity()) ? 1 : 0) == 1;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mMenuDisplayLocation) {
            ...
            /* if (!((Boolean) newValue) && !CentauriActions.isPieEnabled(getActivity())
                    && CentauriActions.isNavBarDefault(getActivity())) {
